        ...
        <fieldset class="row mb-3">
          ...
          <div class="col-sm-10">
            ...
            <div class="form-check">
              <input class="form-check-input" type="radio" name="EgridRadios" value="Apartamento" <?php if (in_array('Apartamento', $Formatos) == true) {
            ...
            <div class="form-check">
              <input class="form-check-input" type="radio" name="EgridRadios" value="Parqueadero" <?php if (in_array('Parqueadero', $Formatos) == true) {
                                                                                                    echo 'checked = "checked"';
                                                                                                  } ?>>
              <label class="form-check-label" for="Edificio">
                Parqueadero
            ...
            <div class="form-check">
              <input class="form-check-input" type="radio" name="EgridRadios" value="Edificio" <?php if (in_array('Edificio', $Formatos) == true) {
                                                                                                  echo 'checked = "checked"';
                                                                                                } ?>>
              <label class="form-check-label" for="Edificio">
                Edificio
